...
public interface CategoryFeignClient {
    ...
    ResponseEntity<ApiResponse<CategoryResponse>> getCategoryById(@PathVariable Long id) throws Exception;

    @GetMapping("/api/categories/salon-owner/category/{id}/salon/{salonId}")
    ResponseEntity<ApiResponse<CategoryResponse>> getCategoryByIdAndSalonId(@PathVariable Long id, @PathVariable Long salonId) throws Exception;
